...
if (isset($_POST['submit'])) {
    ...
    $organizacionNombre = mb_convert_encoding(trim($_POST['inArOrganizacionNombre']), "ISO-8859-1", "UTF-8");
    $sectorNombre = mb_convert_encoding(trim($_POST['inArSectorNombre']), "ISO-8859-1", "UTF-8");
    $areaNombre = mb_convert_encoding(trim($_POST['inArAreaNombre']), "ISO-8859-1", "UTF-8");
    $areaDescripcion = mb_convert_encoding(trim($_POST['inArAreaDescripcion']), "ISO-8859-1", "UTF-8");
    $areaEstado = "1";

    $resultado = $objArea->manInsertarArea($clienteId, $organizacionNombre, $sectorNombre, $areaNombre, $areaDescripcion, $areaEstado, $usuarioModificacion);
...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() {
        ...
        new Autocompleter.Request.HTML($('inArOrganizacionNombre'), '../librerias/autocompleterMantenedores.php', {
...
<div style="min-height: 400px">
    <div id="contenedor">
        ...
        <div class="divFormulario">
            ...
            <form id="frmArIngresar" name="frmArIngresar" method="post" action="manIngresarArea.php" onKeyPress="return manDisableEnterKey(event)">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="inArOrganizacionNombre" id="inArOrganizacionNombre" class="campo" style="text-transform:uppercase;" maxlength="50" value= "<?php echo htmlentities($organizacionNombre) ?>" onchange="manLimpiarInputs('inArSectorNombre','','')" /></td>
                        ...
                        <td valign="top">
                            <div id ="mBoxContainerOrg" class="BoxContainer" style="position: absolute; left:420px; opacity:0;filter:alpha(opacity=0);" height="auto">
                                ...
                                <div class="BoxFooterContainer" align="right">
                                    ...
                                    <input type="button" name="button" class="btn verde" value="Seleccionar" onclick="manSeleccionarOrganizacion('inArOrganizacionNombre')" />   
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="inArSectorNombre" id="inArSectorNombre" class="campo" style="text-transform:uppercase;" maxlength="50" value= "<?php echo htmlentities($sectorNombre) ?>" onfocus="manMostrarSectores('inArOrganizacionNombre','inArSectorNombre')" /></td>                        
                        <td width="20px"><img id="lupaSec" src='../skins/saam/img/lupa.png' style="cursor: pointer" onclick="manSeleccionarSectores('inArOrganizacionNombre')"/></td>
                        ...
                        <td valign="top">
                            <div id ="mBoxContainerSec" class="BoxContainer" style="position: absolute; left:420px; opacity:0;filter:alpha(opacity=0);" height="auto">
                                ...
                                <div class="BoxFooterContainer" align="right">
                                    ...
                                    <input type="button" name="button" class="btn verde" value="Seleccionar" onclick="manSeleccionarSector('inArSectorNombre', 'inArOrganizacionNombre')" />
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="inArAreaNombre" id="inArAreaNombre" class="campo" style="text-transform:uppercase;" maxlength="50" value= "<?php echo htmlentities($areaNombre) ?>" /></td>
                        <td></td>
                        <td><label id="oArea" style="color: #FF0000; font-size: 12px">Debe ingresar un nombre para el &Aacute;rea</label></td>
                    </tr>
                    <tr>
                        <td>Descripción:</td>
                        <td colspan="3"><input type="text" name="inArAreaDescripcion" id="inArAreaDescripcion" class="campoDescripcion" maxlength="250" value= "<?php echo htmlentities($areaDescripcion) ?>" /></td>
                        <td></td>
                        <td></td>
                        <td></td>
        ...
        <p>        
            <br>
            <input type="button" name="button" value="Ingresar" class="btn azul" onclick="manValidarFormularioAreas('inArOrganizacionNombre','inArSectorNombre','inArAreaNombre','btIngresarAr')" />                                
            <label></label>                                
            <input type="button" name="cancelar" id="cancelar" value="Cancelar" class="btn" onclick="location.href = 'manAreas.php'" />
            <input type="submit" name="submit" id="btIngresarAr" value="Ingresar" style="display: none" />
        </p>
