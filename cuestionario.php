        ...
        <div class="positivo" style="display:none;" id="Positivo<? echo $rowCu['preguntaId']; ?>">
            <table border="0">
                <tr>
                    ...
                    <td>
                        <? echo stripslashes(mb_convert_encoding($rowCu['mensajePositivo'], "UTF-8", "ISO-8859-1")); ?>
                    </td>
                </tr>
            </table>
        ...
        <div class="negativo" style="display:none;" id="Negativo<? echo $rowCu['preguntaId']; ?>">
            <table border="0">
                <tr>
                    ...
                    <td>
                        <? echo stripslashes(mb_convert_encoding($rowCu['mensajeNegativo'], "UTF-8", "ISO-8859-1")); ?>
                    </td>
                </tr>
            </table>
        </div>
