...
//CORRECTAS
$query="EXEC listarDatosReporte_RAM '" . $planificacionFecha . "', 1";
...
$query="EXEC listarDatosReporte_RAM '" . $planificacionFecha . "',2";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporte_RAM '" . $planificacionFecha . "',3";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporte_RAM_Resumen '" . $planificacionFecha . "'";
