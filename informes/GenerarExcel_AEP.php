...
//CORRECTAS
$query="EXEC listarDatosReporte_AEP_ISM '$sector','" . $planificacionFecha . "',1";
...
$query="EXEC listarDatosReporte_AEP_ISM '$sector','" . $planificacionFecha . "',2";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporte_AEP_ISM '$sector','" . $planificacionFecha . "',3";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporte_AEP_ISM_Resumen '$sector','" . $planificacionFecha . "'";
