   ...
   while ($row = $base_datos->sql_fetch_assoc($consulta)) {
       ...
       $yyyy=date("Y");
            ...
            if ($consulta1) {
                ...
                $subject=$subject.' '.$sectorNombre;
				
				echo $contactoEmail . "<br><br>";
				
                $resultadoEnvio = enviarCorreoInformes($correoDe, $correoDeNombre, $contactoEmail, $subject, $mensajeCorreo,'RepFlota_Remolcadores.xls');
				
				echo $resultadoEnvio . "<br><br>";
            }
            ...
            if ($consulta2) {
                ...
                $contactoEmail=substr($contactoEmail,0,strlen($contactoEmail)-1);
                $subject=$subject.' '.$sectorNombre;
                $resultadoEnvio = enviarCorreoInformes($correoDe, $correoDeNombre, $contactoEmail, mb_convert_encoding($subject, "ISO-8859-1", "UTF-8"), mb_convert_encoding($mensajeCorreo, "ISO-8859-1", "UTF-8"),'RepEmpresa_AEP.xls');
            }
            ...
            if ($consulta3) {
                ...
                $contactoEmail=substr($contactoEmail,0,strlen($contactoEmail)-1);
                $subject=$subject.' '.$sectorNombre;
                $resultadoEnvio = enviarCorreoInformes($correoDe, $correoDeNombre, $contactoEmail, mb_convert_encoding($subject, "ISO-8859-1", "UTF-8"), mb_convert_encoding($mensajeCorreo, "ISO-8859-1", "UTF-8"),'RepEmpresa_ISM.xls');
            }
...
//                            ECHO "<BR>";
                        ...
                        $subject=$subject.' '.$sectorNombre;
                        $resultadoEnvio = enviarCorreoInformes($correoDe, $correoDeNombre, $contactoEmail, mb_convert_encoding($subject, "ISO-8859-1", "UTF-8"), mb_convert_encoding($mensajeCorreo, "ISO-8859-1", "UTF-8"),'RepGerencia_'.$sectorNombre.'.xls');
