...
//todo:
//CAMBIAR EL SECTOR_ID POR VARCHAR: 'AEP' 'ISM'
//REPLICAR LOS DOS SP, PARA QUE TOME ESE PARAMETRO Y HAGA LOS WHERE DEPENDIENDO DEL VALOR


$fileType = 'Excel5';
$fileName = 'plantillaRepGerencia.xls';
$fileName2 = 'RepEmpresa_'.$sector.'.xls';
...
//CORRECTAS
$query="EXEC listarDatosReporte_AEP_ISM '$sector',$mm,$yyyy,1";
...
$query="EXEC listarDatosReporte_AEP_ISM '$sector',$mm,$yyyy,2";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporte_AEP_ISM '$sector',$mm,$yyyy,3";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporte_AEP_ISM_Resumen '$sector'";
