...
//CORRECTAS
$query="EXEC listarDatosReporteGA $sector,'" . $planificacionFecha . "',1";
...
$query="EXEC listarDatosReporteGA $sector,'" . $planificacionFecha . "',2";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporteGA $sector,'" . $planificacionFecha . "',3";
$result = $base_datos->sql_query($query);
	$indice=2;
	$valores="'";
	while ($row = $base_datos->sql_fetch_assoc($result)) {
...
$query="EXEC listarDatosReporteGAResumen " . $sector . ",'" . $planificacionFecha . "'";
