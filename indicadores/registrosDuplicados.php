...
<div class="divElementos">
    ...
    <div style="min-height: 400px">
        ...
        <div>
                ...
                <form name="formConsulta1" id="formConsulta1" method="post" >
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="button" id="boton1" name="button" class="btn azul" value="Buscar" onclick="seleccionarRegistrosDuplicados();" style="position: relative; left: 14px;"/>
                            </td>
            ...
            <!--- Formulario que muestra los envios duplicados --->

            <div id="repo_hold3" style="position: fixed; top: 0px; left: 0px; width: 100%; height: 100%;text-align: center; visibility: hidden;background-color:rgba(0,0,0,0.8);  ">
                <div><br><br><br>
                </div>
                <div style="border: solid 1px #000;display: inline-block; width: 80%; height: 80%; margin: 0px; vertical-align: bottom; background-color: #FFF;" id="repo_id3">
                ...
                <!--- Formulario que muestra el detalle de los envios duplicados --->

                <div id="repo_hold4" style="position: fixed; top: 0px; left: 0px; width: 100%; height: 100%;text-align: center; visibility: hidden;background-color:rgba(0,0,0,0.8);  ">
                    <div><br><br><br>
                    </div>
                    <div style="border: solid 1px #000;display: inline-block; width: 80%; height: 80%; margin: 0px; vertical-align: bottom; background-color: #FFF;" id="repo_id4">
                ...
                <!--- Formulario para eliminar los envios duplicados --->

                <div id="repo_hold5" style="position: fixed; top: 0px; left: 0px; width: 100%; height: 100%;text-align: center; visibility: hidden;background-color:rgba(0,0,0,0.8);  ">
                    <div><br><br><br>
                    </div>
                    <div style="border: solid 1px #000;display: inline-block; width: 80%; height: 80%; margin: 0px; vertical-align: bottom; background-color: #FFF;" id="repo_id5">
