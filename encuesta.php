...
<br/>
<textarea name="Comentario" id="Comentario" rows="4" cols="40" <?if($rUsuario!=''){ echo 'DISABLED';} ?> style="border:solid 1px #135293;" onkeyup="isAlfaNum(this);contarCaracteres();"><? echo $comentario;?></textarea>
