...
<td>
                   ...
                   <table border="0" style='border:none;margin:0px;' CELLSPACING='0' CELLSPADDING='0'>
			<tr>
			<!--
			<table border="0" style='border:1px solid #4B6C9F;margin:0px;' CELLSPACING='0' CELLSPADDING='0'>
			<tr>
			...
			<td style='width:250px;height:75px;' align='center'>
				<img src='<? echo $logo; ?>' border='0' height='75%'>
			</td>-->
			    <td style="width:950px;height:75px;"><img src="skins/saam/img/headerComercial.jpg"/></td>
			</tr>			
			</table>
...
<table border="0" width="100%">
	...
	<tr>
		<td align="center">
			...
			$url="http://".$_SERVER['HTTP_HOST'].'/capsula20/'.$direccion_final;
...
<script>
  ...
  //Esta función bloquea los controles de la cápsula cuando está cerrada:
