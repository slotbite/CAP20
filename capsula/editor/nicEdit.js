...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'left' : {name : __('Alinear a la izquierda'), command : 'justifyleft', noActive : true},
		'center' : {name : __('Centrar'), command : 'justifycenter', noActive : true},
		'right' : {name : __('Alinear a la derecha'), command : 'justifyright', noActive : true},
		'justify' : {name : __('Justificar'), command : 'justifyfull', noActive : true},
		'ol' : {name : __('Viñetas'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('Numeración'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('Subíndice'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Superíndice'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('Tachado'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('Remover formato'), command : 'removeformat', noActive : true},
		'indent' : {name : __('Indentar'), command : 'indent', noActive : true},
		'outdent' : {name : __('Remover indentado'), command : 'outdent', noActive : true},
...
var nicEditorInstance = bkClass.extend({
    ...
    construct : function(e,options,nicEditor) {
        ...
        if(isTextarea || this.options.hasPanel) {
            ...
            var s = {width: newX+'px', border : 'none', padding: '2px', margin: '1px', borderTop : 0, overflowY : 'auto', overflowX: 'hidden' };
            ...
            /*********/
            var editorElm = new bkElement('DIV').setStyle({width : (newX-1)+'px', margin: '0px', minHeight : newY+'px'}).addClass('main').appendTo(this.editorContain);
