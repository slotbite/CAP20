...
include('clase/capsula.class.php');
...
<script type="text/javascript">
    ...
    bkLib.onDomLoaded(function() { 
		...
		// new nicEditor({buttonList : ['bold','italic','underline','left','center','right','justify','ol','ul', 'subscript','superscript','strikethrough','removeformat','indent','outdent','fontSize','fontFormat']}).panelInstance('tEditorFeedback');
    });
...
//alert('fadeando');			
		...
		$('#aFeedback').click(function() {
			...
			//alert('Bienvenido:/n 1.-Las opciones sin editar seran omitidas/n2.-Debes crear minimo 1 pregunta por Feedback/n adios ');
            $("#id_feedback").attr('value', '0');			
            $("#overlay").css('filter', 'alpha(opacity=50)');
            $('#overlay').fadeIn();
            $('#divFeedback').css({visibility: "visible", zIndex:"2000", top:'53'}).animate({opacity: 1}, 500);      
			
			//alert('fadeando');
			document.getElementById('divFeedbackScroll').scrollTop = 0;
			//nicEditors.findEditor('tEditorFeedback').setContent('');
            return false;
        });
        ...
        $('.cerrarPopUp').click(function() {
			...
			$('#divFeedback').css({visibility: "invisible", zIndex:"0"}).animate({opacity: 0}, 500);
...
<script type="text/javascript" src="http://www.fakeyourbeauty.com/jquery.autosize.input.js"></script>
...
<input id="administradorId" type="hidden" value="<? echo $administradorId; ?>"/>
    ...
    <!--                    <input id="imagenArchivo" type="file" name="archivos[]"  class="filestyle" onchange="subirImagen();"/>-->
        ...
        <div id="divPregunta">
            ...
            <table class="tablaEstructura">
                <tr>
                    <td valign="top" style="border-bottom: 1px solid #CDCDCD; font-size: 14px; height: 20px">
                        <img src="../css/imagenes/asistente/preguntas.png" height="20" width="20">&nbsp;
						<b>Contenido: Pregunta</b>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
        ...
        <!-- Feedback -->
        <div id="divFeedback">
		<input id="id_feedback" type="hidden" value="0">
            <table class="tablaEstructura">
				
                <tr >
                    <td valign="top" style="border-bottom: 1px solid #CDCDCD; font-size: 14px; height: 20px">
                        <img src="../css/imagenes/asistente/Feedback.jpg" height="20" width="20">&nbsp;
						<b >Feedback: </b>
                    </td>
                </tr>
				<tr>
                    <td valign="top">
                        <div id="divFeedbackScroll" style="height:200px; width:1125px; overflow-y: scroll; ">
							<table>

								
								<br>Instrucciones:<br>
								1.-Completar al menos un parametro y una pregunta <br>
								<br>
				
								
								<tr>
									<td id="tdPreguntas" style="height: 130px" valign="top">
										<table id="tablaFeedback" cellpadding="0" cellspacing="0">
											<tr id='first'>
												<td></td>
												<td></td>
												...
												<td class='Feed' ><input  id='opcion_1' class='textbox' type="text"   maxlength="20"  data-autosize-input='{ "space": 5 }' /></td>
												<td class='Feed' ><input  id='opcion_2' class='textbox' type="text"   maxlength="20"  data-autosize-input='{ "space": 5 }' /></td>
												<td class='Feed' ><input  id='opcion_3' class='textbox' type="text"   maxlength="20"  data-autosize-input='{ "space": 5 }' /></td>
												<td class='Feed' ><input  id='opcion_4' class='textbox' type="text"   maxlength="20"  data-autosize-input='{ "space": 5 }' /></td>
												<td class='Feed' ><input  id='opcion_5' class='textbox' type="text"   maxlength="20"  data-autosize-input='{ "space": 5 }' /></td>
												<td  ></td>
											</tr>
											<tr >
												<td></td>
												<td>1 ) </td>
												<td ><input type="text" class="textbox" placeHolder="Pregunta a" style="min-width:400px" maxLength="1000" data-autosize-input='{ "space": 5 }'/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed' ><img src="../css/imagenes/asistente/eliminar.png" onClick="eliminarPregunta(this)"/></td>
											</tr>
											<tr >
												<td></td>
												<td>2 ) </td>
												<td ><input type="text" class="textbox" placeHolder="Pregunta b" style="min-width:400px" maxLength="1000" data-autosize-input='{ "space": 5 }'/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
											...
											<tr class="trPregunta" >
												<td></td>
												<td>3 ) </td>
												<td ><input type="text" class="textbox" placeHolder="Pregunta c" style="min-width:400px" maxLength="1000" data-autosize-input='{ "space": 5 }' onFocus="agregarPregunta(this)" onBlur="agregarPreguntaB(this)"/> </td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
												<td class='Feed'  ><input type="radio" disabled name="FEED"/></td>
				...
				<tr>
					<td valign="bottom" align="right">
						<input type="button" class="btn cerrarPopUp" value="Cancelar"> &nbsp
						<input type="button" class="btn cafe" value="Guardar" onClick="capCrearFeedback()">
					</td>
				</tr>
            ...
            <div id="divPrecarga2" style="display:none">
                ...
                <div id="fl_menu">
                    ...
                    <div id="menuOpciones" class="menu">
						...
						<a id="aFeedback" href="#" class="menu_item" title="Feedback"><img src="../css/imagenes/asistente/Feedback.jpg" height="40" width="40"></a>						
