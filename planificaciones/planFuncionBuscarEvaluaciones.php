...
$consulta = $objPlanificacion->planBuscarEvaluaciones($clienteId);

if ($consulta) {

    $count = 0;

    $lista = "<table id='tablaListaEvaluaciones' class='tabla'><tbody>";
    //$lista.= '<tr><th></th><th>Evaluación</th></tr></thead>';
