...
var myMooEditableInstance;
		...
		if (cantidad==0){
			...
			if(tipocapsula==3){
				...
				var elRequest1 = new Request({
						...
						$('IrWizard3').action='wizard_capsula_fin1.php'
						$('IrWizard3').submit();
				...
				$('IrWizard3').submit();	
					...
					$('IrWizard3').action='wizard_capsula_3b.php'
					$('IrWizard3').submit();
				}
			}
		}
	...
	function cancelar(){
		if (confirm('Perder\u00e1 todos los cambios realizadoa a la C\u00e1psula\nEst\u00e1 Seguro?')==true){
...
$plantilla->setTemplate("wizard_capsula_2");
